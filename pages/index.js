...
export default function Home() {
	...
	return (
		<>
			<Head>
				<title>System zarządzania pracownikami</title>
	...
	return (
		<div className="flex gap-5">
			...
			<button
				...
				className="flex bg-green-500 text-white px-4 py-2 border rounded-md hover:bg-green-500 hover:green-red-500 hover:text-gray-500"
			>
				NIE{" "}
				<span className="px-1">
